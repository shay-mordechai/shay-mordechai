...
* **Quantitative AI Stack:** Architected an automated engine fusing **XGBoost ML** models with a **Google Gemini LLM** integration for real-time market anomaly detection.
* **Threat & Log Analysis:** Built foundational data processing architectures capable of parsing massive datasets—skills directly translatable to Incident Response and large-scale SIEM log analysis.
